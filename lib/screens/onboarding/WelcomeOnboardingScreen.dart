...
const List<_PsychQuestion> _kQuestions = [
  ...
  _PsychQuestion(
    question: 'Bạn có thường xuyên lo lắng về tương lai hoặc những điều chưa xảy ra không?',
    options: [
  ...
  _PsychQuestion(
    question: 'Bạn thường dành bao nhiêu thời gian cho bản thân mỗi ngày (không làm việc)?',
    options: [
  ...
  _PsychQuestion(
    question: 'Bạn có từng thử thiền định, hít thở có chủ đích hoặc các kỹ thuật thư giãn chưa?',
    options: [
      'Chưa bao giờ thử',
...
class _WelcomeOnboardingScreenState extends State<WelcomeOnboardingScreen> {
  ...
  void _finish() {
    final List<int> answered = _answers
        .map((int? a) => a ?? 0)
        .toList();
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
            'Trước khi bắt đầu, hãy để ứng dụng hiểu rõ hơn về bạn qua 3 câu hỏi ngắn.\n\nThông tin này giúp ZenWave đưa ra đánh giá và gợi ý chính xác hơn sau này.',
            style: TextStyle(
              fontSize: 15.5,
              height: 1.6,
              color: AppColors.neutral700,
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildPrimaryButton(
            label: questionIndex < _kQuestions.length - 1 ? 'Tiếp theo' : 'Hoàn tất',
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          const Text(
            'ZenWave đã ghi nhận thông tin của bạn. Hãy đeo headband, kết nối thiết bị và bắt đầu hành trình chăm sóc tâm trí.',
            textAlign: TextAlign.center,
            style: TextStyle(
              fontSize: 15.5,
              height: 1.6,
