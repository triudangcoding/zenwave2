...
class MeditationPage extends StatelessWidget {
    ...
    return Container(
      ...
      child: Stack(
        children: [
          Padding(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  flex: 3,
                  child: const SizedBox(), // Khoảng trống để text luôn nằm bên trái và không đè lên ảnh
                ),
              ],
            ),
          ),
          Positioned(
            right: 12,
            bottom: 20, // Kéo phần đáy của ảnh lên bằng với mép dưới của Padding => ngang bằng nút "Bắt Đầu Ngay"
            child: Image.asset(
              'assets/Images/123123.png', 
              height: 130, // Điều chỉnh nhẹ lại kích thước sau khi đã đưa ảnh lên để không bị lấn mất tiêu đề
              fit: BoxFit.contain,
        ...
        Expanded(
          child: Container(
            ...
            child: Row(
              ...
              children: [
                const Icon(Icons.self_improvement, color: Color(0xFF199A37), size: 34),
        ...
        Expanded(
          child: Container(
            ...
            child: Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                const Icon(Icons.folder_special_outlined, color: Color(0xFFF29B18), size: 34),
                const SizedBox(width: 10),
                Flexible(
                  child: const Text(
                    'Bài thiền\nđã lưu',
  ...
  Widget _buildGridBasic() {
    return GridView.count(
      ...
      crossAxisSpacing: 16,
      mainAxisSpacing: 12,
      childAspectRatio: 1.9, // Vẫn thấp hơn trước nhưng đủ chỗ để tránh overflow
      children: [
        _buildBasicCard('Làm quen với\nthiền định', '10 bài thiền'),
        _buildBasicCard('Làm quen với\nthiền định', '10 bài thiền'),
        _buildBasicCard('Làm quen với\nthiền định', '10 bài thiền'),
        _buildSeeAllCard(false),
      ],
    );
  }
  ...
  Widget _buildBasicCard(String title, String subtitle) {
    return Container(
  ...
  Widget _buildSeeAllCard(bool isAdvanced) {
    return Container(
      decoration: BoxDecoration(
        color: isAdvanced ? const Color(0xFFEDEDED) : const Color(0xFFFAFAFA),
        borderRadius: BorderRadius.circular(20),
